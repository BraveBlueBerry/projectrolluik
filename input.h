void doSomethingWithInput(){
	...
	if(c==0){				// opcode 0000 0000
		//setStatus(/*get value from centrale*/);
	}
	if(c==1){				// opcode 0000 0001
		//setMinTemp(/*get value from centrale*/);
	}
	if(c==2){				// opcode 0000 0010
		//setMaxTemp(/*get value from centrale*/);	
	}
	if(c==3){				// opcode 0000 0011
		//setMaxLight(/*get value from centrale*/);
	}
	if(c==4){				// opcode 0000 0100
		//setMinHeightBlind(/*get value from centrale*/);
	}
